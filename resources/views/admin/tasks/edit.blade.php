<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h4 mb-0">{{ __('messages.Edit Task') }} - {{ $initiative->getLocalizedName() }}</h2>
            ...
            <div class="col-md-10">
                <div class="card shadow-sm">
                    <div class="card-header bg-white">
                        <h5 class="card-title mb-0">{{ __('messages.Edit') }} {{ $task->getLocalizedTitle() }}</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.initiatives.tasks.update', [$initiative, $task]) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('title_en') is-invalid @enderror" 
                                               ...
                                               value="{{ old('title_en', $task->title['en'] ?? '') }}" required>
                                        @error('title_en')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('title_ar') is-invalid @enderror" 
                                               ...
                                               value="{{ old('title_ar', $task->title['ar'] ?? '') }}" required>
                                        @error('title_ar')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                                  id="description_en" name="description_en" rows="4">{{ old('description_en', $task->description['en'] ?? '') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                                  id="description_ar" name="description_ar" rows="4">{{ old('description_ar', $task->description['ar'] ?? '') }}</textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('points_value') is-invalid @enderror" 
                                               id="points_value" name="points_value" 
                                               value="{{ old('points_value', $task->points_value) }}" 
                                               min="1" required>
                                        @error('points_value')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
